...
After the instalation is done you can check your install by running `pixi run test` or alternatively `pixi run -e cuda test` to check if the gpu is supported.
